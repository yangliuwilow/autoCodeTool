...
public class InterfaceMethedPlugin extends PluginAdapter {
    ...
    public void initialized(IntrospectedTable introspectedTable) {
        // 数据库表名
        String tableName = introspectedTable.getFullyQualifiedTableNameAtRuntime().replace("tb_","");
        // 主键
    ...
    public boolean sqlMapDocumentGenerated(Document document, IntrospectedTable introspectedTable) {
        ...
        String model = StringUtil.lineToHump(ObjectUtils.toString(tableName.replace("tb_","")));

        Attribute newAttribute=new Attribute(attribute.getName(),"com.xyy.ec.order.core.dao."+model+"Mapper");
