...
<table style="border:1px red;">
    ...
    <tr>
        ...
        <td>xyymysql</td>
        <td>xyy</td>
        <td style="width: 160px;"><a href="${ctx}/list?jdbc_driver=com.mysql.jdbc.Driver&jdbc_url=jdbc:mysql://db2-dev.mysql.ybm100.top:3307/xyy_ec_order?createDatabaseIfNotExist=true&useUnicode=true&characterEncoding=utf8&autoReconnect=true&allowMultiQueries=true&jdbc_username=superuser&jdbc_password=superuser123&database=xyy_ec_order">选择table生成</a>
            <a href="${ctx}/createByReq?jdbc_driver=com.mysql.jdbc.Driver&jdbc_url=jdbc:mysql://db2-dev.mysql.ybm100.top:3307/xyy_ec_order?useUnicode=true&characterEncoding=gbk&jdbc_username=superuser&jdbc_password=superuser123&database=xyy_ec_order">生成</a></td>
    </tr>
